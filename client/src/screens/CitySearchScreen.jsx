    ...
    <div className="space-y-8 pb-20 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 mt-1">
          Explore 50+ hand-curated world destinations with popularity ratings, daily cost indices, and iconic attraction previews.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="p-12 rounded-3xl white-card text-center space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-900">No Cities Match Your Search</h3>
